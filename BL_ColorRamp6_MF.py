...
### Creating Nodes
Color1 = create_expression(BL_ColorRamp6,unreal.MaterialExpressionConstant3Vector,-1580.0, 3880.0)
Position1 = create_expression(BL_ColorRamp6,unreal.MaterialExpressionConstant,-1580.0, 3800.0)
Mix = create_expression(BL_ColorRamp6,unreal.MaterialExpressionLinearInterpolate,-340.0, 3620.0)
Position0 = create_expression(BL_ColorRamp6,unreal.MaterialExpressionConstant,-1580.0, 3540.0)
Color0 = create_expression(BL_ColorRamp6,unreal.MaterialExpressionConstant3Vector,-1580.0, 3620.0)
...
Color2 = create_expression(BL_ColorRamp6,unreal.MaterialExpressionConstant3Vector,-1560.0, 4620.0)
Mix01 = create_expression(BL_ColorRamp6,unreal.MaterialExpressionLinearInterpolate,-20.0, 4480.0)
Position2 = create_expression(BL_ColorRamp6,unreal.MaterialExpressionConstant,-1560.0, 4540.0)
...
Color3 = create_expression(BL_ColorRamp6,unreal.MaterialExpressionConstant3Vector,-1360.0, 5400.0)
...
Position3 = create_expression(BL_ColorRamp6,unreal.MaterialExpressionConstant,-1360.0, 5320.0)
...
Color4 = create_expression(BL_ColorRamp6,unreal.MaterialExpressionConstant3Vector,-1360.0, 6160.0)
Position4 = create_expression(BL_ColorRamp6,unreal.MaterialExpressionConstant,-1360.0, 6080.0)
...
Color5 = create_expression(BL_ColorRamp6,unreal.MaterialExpressionConstant3Vector,-1360.0, 6920.0)
Position5 = create_expression(BL_ColorRamp6,unreal.MaterialExpressionConstant,-1360.0, 6840.0)
...
OutputResult = create_expression(BL_ColorRamp6, unreal.MaterialExpressionFunctionOutput,400, 6780)
